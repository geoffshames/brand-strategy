...
export function SplitChars({ text, className = '', charClass = 'rg-char' }: { text: string; className?: string; charClass?: string }) {
  return (
...
export function SplitWords({ text, className = '', wordClass = 'rg-word' }: { text: string; className?: string; wordClass?: string }) {
  return (
    <span className={className} aria-label={text} role="text">
...
export function MaskedLines({ lines, className = '', lineClass = 'rg-line' }: { lines: string[]; className?: string; lineClass?: string }) {
  return (
