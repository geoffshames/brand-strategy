  ...
  return (
    <SectionWrapper id="funnel" className="bg-[#0D0D0D] border-y border-[#1E1E1E]">
      <div className="max-w-5xl mx-auto px-6 md:px-8">
        <div className="mb-14">
          <p className="text-xs text-[#FD3737] uppercase tracking-[0.2em] font-semibold mb-4">Diagnosis</p>
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">The Inverted Funnel</h2>
          <div className="w-24 h-1 bg-[#FD3737] mb-6" />
          <p className="text-base md:text-lg text-[#B8B8C0] max-w-3xl">
            Awareness was bought and earned at the top. Almost none of it has been routed downward into habit,
            ownership, and revenue. Every pillar in this strategy exists to widen the bottom of this picture.
          </p>
        </div>
          ...
          {funnel.map((f, i) => {
            ...
            return (
              <div key={i} className="flex flex-col items-center">
                ...
                >
                  <span className="text-[11px] md:text-xs uppercase tracking-[0.15em] font-semibold text-white/90 whitespace-nowrap">{f.stage}</span>
                  <span className="text-lg md:text-2xl font-bold text-white tabular-nums whitespace-nowrap" style={{ fontFamily: "'N27', 'Work Sans', sans-serif" }}>
                    {f.display}
                  </span>
                </div>
