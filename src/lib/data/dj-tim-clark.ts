...
export const djTimClark: BrandStrategy = {
  ...
  brandAudit: {
    ...
    socialAccounts: [
      { platform: 'Instagram', handle: '@timclarklive', url: 'https://instagram.com/timclarklive', followers: 120000 },
      { platform: 'TikTok', handle: '@timclarklive', url: 'https://tiktok.com/@timclarklive' },
  ...
  swot: {
    strengths: [
      {
        title: 'Award-Winning Legitimacy',
        description: 'Two EDMA wins (Breakthrough Artist 2024 & 2025) provide external validation that can\'t be bought.',
        evidence: 'EDMA 2024 & 2025 Winner: Breakthrough Artist of the Year (Trance), Breakout Artist on Tour. Las Vegas Weekly Best DJ 2025 Readers\' Choice.',
      },
      {
      ...
      {
        title: 'Social Infrastructure at Scale',
        description: '120K Instagram followers is rare at this career stage. Most Coldharbour artists with 3-5x Tim\'s streaming have a fraction of his social following.',
        evidence: '120K Instagram vs 2.4K Spotify monthly listeners. 50:1 ratio gap = untapped conversion opportunity.',
      },
      {
  ...
  executiveSummary: {
    ...
    primaryRecommendation: 'Complete a music-first rebrand (website, press kit, social strategy) while executing a disciplined 3-4 week release cadence. Reduce local Vegas frequency, secure 2-3 premium residencies, and activate direct-to-fan infrastructure (email, TikTok sound seeding, Discord). Target 50K Spotify monthly listeners and 8-10 festival bookings within 12 months.',
  ...
  strategicPillars: [
    ...
    {
      title: 'Earn the Festival',
      thesis: 'Transition from local residency DJ to festival-circuit artist requires deliberate market repositioning. Reduce downtown Vegas frequency, secure 2-3 premium residency slots (Zouk, XS-tier venues) instead, and build an international touring dossier proving audience draw beyond the home market. EDC 2026 is already confirmed—that\'s the proof-of-concept.',
      successMetrics: [
        'Troy Liquor Bar frequency: weekly → 2x per month',
        'Premium Vegas residencies: 0 → 2-3 (Zouk, XS, LIV tier)',
        'Festival bookings 2027: 8-10 confirmed (mid-tier stages)',
        'International touring: 6-8 dates (Europe, Asia, Latin America)',
      ],
      keyInitiatives: [
        'Pitch premium Vegas venues for residency slots',
        'Submit festival applications for 2027 season',
        'Build international booking package',
        'Leverage Coldharbour network for promoter introductions',
      ],
    },
    {
      title: 'Activate the Core',
      thesis: 'The 120K Instagram following is passive. Converting even 10% to active fans who pre-save, share sounds, attend shows, and buy merch would transform Tim\'s metrics overnight. Direct-to-fan strategy: email/SMS list building, Discord or community platform, exclusive content tiers, and superfan identification.',
      successMetrics: [
  ...
  roadmap: [
    ...
    },
    {
      ...
      actions: [
        ...
        { action: 'Secure 2-3 premium Vegas residency slots (Zouk, XS-tier)', deadline: 'Aug 31, 2026' },
        { action: 'Submit festival applications for 2027 season', deadline: 'Sep 15, 2026' },
        ...
        { action: 'International booking push (Europe, Asia based on existing contacts)', deadline: 'Sep 30, 2026' },
      ],
      expectedOutcomes: [
        'Spotify monthly listeners: 2.4K → 10K–15K',
        'Premium residencies booked and promoted',
        'Festival submissions completed (15+ events)',
    ...
    },
    {
      ...
      actions: [
        ...
        { action: 'ADE 2026 performance + networking push', deadline: 'Oct 15, 2026' },
        { action: 'Confirm Miami Music Week 2027 bookings', deadline: 'Nov 30, 2026' },
      ...
      expectedOutcomes: [
        ...
        'Festival bookings: 4-6 confirmed for summer 2027',
        'Discord community: 1K+ active members',
        'Email list: 7K+ subscribers',
        'International tour dates: 3-4 booked',
      ],
    },
    {
      phase: 'Phase 4',
      ...
      actions: [
        ...
        { action: 'Execute festival season 2027 bookings (8-10 events)', deadline: 'Apr 30, 2027' },
        { action: 'Groove Cruise and cruise circuit as premium touchpoint', deadline: 'Mar 31, 2027' },
      ...
      expectedOutcomes: [
        ...
        'Festival season 2027: 8-10 performances executing',
  ...
  kpiFramework: [
    ...
    },
    {
      ...
      current: '120,000',
      target: '175,000',
      benchmark: 'Nifra: 295K, Estiva: 120K (parity), Daxson: 85K (upside)',
      timeframe: '12 months',
      rationale: 'Quality over quantity. Focus is conversion (pre-saves) not follower growth. Modest growth (55K) accounts for organic + paid acquisition.',
    },
    {
      metric: 'TikTok Followers',
      current: '~5,000 (estimated)',
      target: '50,000',
      benchmark: 'Emerging artist standard in electronic music space',
      timeframe: '12 months',
      rationale: 'Sound seeding platform. 50K followers creates algorithm leverage for release soundtracks.',
    },
    {
    ...
    },
    {
      ...
      target: '8-10',
      benchmark: 'Mid-tier trance/progressive artists: 8-12 annually',
      timeframe: '12 months',
      rationale: 'Career milestone. Festival bookings validate touring artist status and generate revenue.',
    },
    {
  ...
  recommendations: [
    ...
    {
      title: 'Reduce Vegas Residency Frequency',
      description: 'Cut Troy Liquor Bar from weekly to biweekly/monthly. Pitch premium venues (Zouk, LIV, XS) for quarterly residencies.',
      rationale: 'Downtown Vegas overexposure reads as "local DJ." Premium venues = festival-circuit positioning.',
      timeline: '30–60 days (high priority)',
      priority: 'high',
      expectedOutcome: 'Brand perception shifts from local to touring artist. Festival booking pitch improves.',
    },
    {
